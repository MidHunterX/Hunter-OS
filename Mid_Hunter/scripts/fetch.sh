...
echo -e "  ${X}oMMMM${Y}yyy${X}      ${Y}yyy${X}MMMMo${R}   ${B}Datetime:${R} $(date +"%Y ${V}%d${R} %b ${V}%H:%M${R} %a")"
...
echo -e "  ${X}oMMo ${Y} *o${X}      ${Y}o* ${X} oMMo${R}   ${B}SSD:${R} Micron MTFDHBA512QFD 512GB"
echo -e "  ${X}oMMo ${Y}   ${X}      ${Y}   ${X} oMMo${R}   ${B}RAM:${R} Hynix HMA851S6DJR6N-XN 2x4GB"
