...
*Modal Interaction First*: Modes are always preferred first then modifiers.
Same keys can do many different things depending on different contextual modes.

*Context Switching*: You should be able to move away from one place to another
for accessing an isolated environment with different intention.
