...
====
[discrete]
== ⚗️ Experimentally Engineered Empathic Environment
...
| link:.config/VSCodium/User/[🆚 VSCode]
| GUI Code Editor
| image:.config/VSCodium/User/.assets/code.jpg[,128,link=.config/VSCodium/User/]
...
| vscodium-bin        | Open Source build of VSCode | yay
|===
====
