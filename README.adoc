...
contexts. E.g. (vifm) VIFM_MODE in terminal for accessing an isolated sub-shell
environment inside another shell for temporary context switch.
...
Ambient notification system as Mark Weiser's Calm technology, Active Agentic
