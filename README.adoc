...
expression & vifm --> ai[ai_theme.pl]
...
hypr -.Cursor Jump (Meta+c f).-> cursor
...
link:Mid_Hunter/scripts/ai_theme.pl[Adaptive Window Contrast]: An adaptive
...
image:Mid_Hunter/scripts/.assets/auto_adaptation.jpg[link=Mid_Hunter/scripts/ai_theme.pl]
