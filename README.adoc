...
`matugen` is used to generate dynamic Material You colors. Currently, each config is in the process of getting fallback colors for portability.

|===
| 🟢 | matugen Optional (Plug n Play Friendly)
| 🔴 | matugen Required for now
|===
