...
Both solutions are non-plug-n-play friendly. Therefore use custom made status bar, logout screen etc. with a GUI shell framework like Astal with AGS or QuickShell.
====
...
hypr -.Cursor Mode (Meta c).-> cursor
